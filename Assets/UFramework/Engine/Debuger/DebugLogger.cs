...
namespace UFramework.Engine.Debuger
{
    [SingletonMonoTAttribute("[Tools]/DebugLogger")]
	public class DebugLogger : SingletonMonoT<DebugLogger>
	{
        ...
        public void InitDebuggerLog(string dumpPath, bool dump2File, bool dump2Screen)
		{
			...
			{
				if(m_Dump2File && File.Exists(m_Outpath))
				{
